...
saveRDS(boot_out, '3_hyp_2_conv/analysis_hyp2/boot_hyp2_5000.rds')
boot_out <- readRDS("3_hyp_2_conv/analysis_hyp2/boot_hyp2_5000.rds")
...
ggsave(plot = whole_plot, filename = '3_hyp_2_conv/analysis_hyp2/hyp_2_dstrib.png', height = 8, width = 10)

system("open 3_hyp_2_conv/analysis_hyp2/hyp_2_dstrib.png")
