...
stroop_plot <- ggplot(weight_table, aes(x = weight_rt, y = t0, group = modality, color = modality)) +
  geom_line() +
  geom_point(size = 2) +
  geom_errorbar(
...
ggsave(plot = stroop_plot, file = 'study_1_reliability/plots/bootstrap_50_excl/stroop_boot.png', width = 8, height = 4)
